...
/*-----------------------------------------------
              @(target):= _rbf_solver.so
  ------------------------------------------------*/
#define SWIG_init    init_rbf_solver

#define SWIG_name    "_rbf_solver"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_rbf_solver(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOO:rbf_solver",&obj0,&obj1,&obj2,&obj3,&obj4)) SWIG_fail;
  {
  ...
  if (!SWIG_IsOK(ecode9)) {
    SWIG_exception_fail(SWIG_ArgError(ecode9), "in method '" "rbf_solver" "', argument " "9"" of type '" "double""'");
  } 
  arg9 = (double)(val9);
  rbf_solver(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9);
...
static PyMethodDef SwigMethods[] = {
	 { (char *)"rbf_solver", _wrap_rbf_solver, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
