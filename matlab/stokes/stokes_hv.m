...
[i_ind, j_ind, v_val] = find( -2 * spdiags(dEta_dx,0,N,N) * RBFFD_WEIGHTS.xsfc - spdiags(dEta_dy,0,N,N) * RBFFD_WEIGHTS.ysfc - spdiags(dEta_dz,0,N,N) * RBFFD_WEIGHTS.zsfc - spdiags(eta,0,N,N) * (RBFFD_WEIGHTS.lsfc - RBFFD_WEIGHTS.scaled_hv)  ); 
li = length(i_ind);
if li
...
[i_ind, j_ind, v_val] = find( RBFFD_WEIGHTS.xsfc - RBFFD_WEIGHTS.scaled_hv );
li = length(i_ind);
if li
    c_i_ind = cur_ind:(cur_ind+li-1);
...
[i_ind, j_ind, v_val] = find( -spdiags(dEta_dx,0,N,N) * RBFFD_WEIGHTS.xsfc - 2 * spdiags(dEta_dy,0,N,N) * RBFFD_WEIGHTS.ysfc - spdiags(dEta_dz,0,N,N) * RBFFD_WEIGHTS.zsfc - spdiags(eta,0,N,N) * (RBFFD_WEIGHTS.lsfc - RBFFD_WEIGHTS.scaled_hv)  );
li = length(i_ind);
if li
    c_i_ind = cur_ind:(cur_ind+li-1);
    II(c_i_ind) = i_ind + 1*N;
...
[i_ind, j_ind, v_val] = find(  RBFFD_WEIGHTS.ysfc - RBFFD_WEIGHTS.scaled_hv  ); 
li = length(i_ind);
if li
    c_i_ind = cur_ind:(cur_ind+li-1);
    II(c_i_ind) = i_ind + 3*N;
...
[i_ind, j_ind, v_val] = find( -spdiags(dEta_dx,0,N,N) * RBFFD_WEIGHTS.xsfc - spdiags(dEta_dy,0,N,N) * RBFFD_WEIGHTS.ysfc - 2 * spdiags(dEta_dz,0,N,N) * RBFFD_WEIGHTS.zsfc - spdiags(eta,0,N,N) * (RBFFD_WEIGHTS.lsfc - RBFFD_WEIGHTS.scaled_hv)  ); 
li = length(i_ind);
if li
    c_i_ind = cur_ind:(cur_ind+li-1);
    II(c_i_ind) = i_ind + 2*N;
...
[i_ind, j_ind, v_val] = find( RBFFD_WEIGHTS.zsfc - RBFFD_WEIGHTS.scaled_hv  ); 
li = length(i_ind);
if li
    c_i_ind = cur_ind:(cur_ind+li-1);
    II(c_i_ind) = i_ind + 3*N;
