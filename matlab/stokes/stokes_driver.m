...
c1_kappa.n40 = [0.243, 0.148, 0.106, 0.077, 0.055, 0.038, 0.027, 0.020, 0.024, 0.025];
c2_kappa.n40 = [0.420, 0.047, 0.157, 0.220, 0.239, 0.222, 0.274, 0.295, 0.25, 0.28];
kappa.n40 = [2, 4, 6, 8, 10, 12, 14, 16];

% The last two were hand tuned
%% BEST: 14 (kk=7), end of list is fine tuned (kk=11)
c1_kappa.n60 = [0.258, 0.156, 0.116, 0.088, 0.067, 0.050, 0.037, 0.028, 0.018, 0.034, 0.0345];
c2_kappa.n60 = [0.635, 0.043, 0.162, 0.228, 0.244, 0.255, 0.262, 0.306, 0.423, 0.22, 0.225];
kappa.n60 = [2, 4, 6, 8, 10, 12, 14, 16, 18];

% The last two were hand tuned
%% BEST: 14 (kk=7), end of list is fine tuned (kk=11)
c1_kappa.n80 = [0.260, 0.161, 0.122, 0.095, 0.074, 0.058, 0.045, 0.035, 0.023, 0.0441, 0.043];
c2_kappa.n80 = [0.497, 0.051, 0.160, 0.251, 0.251, 0.285, 0.311, 0.289, 0.309, 0.311, 0.3];
kappa.n80 = [2, 4, 6, 8, 10, 12, 14, 16, 18];


% The last two were hand tuned
%% BEST: 14 (kk=6), end of list is fine tuned (kk=9)
c1_kappa.n100 = [0.164, 0.126, 0.099, 0.079, 0.063, 0.050, 0.039, 0.029, 0.049];
c2_kappa.n100 = [0.067, 0.178, 0.248, 0.263, 0.283, 0.308, 0.293, 0.326, 0.305];
