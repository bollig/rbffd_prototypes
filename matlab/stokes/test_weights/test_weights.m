...
for indx = 1:4
    ...
    for i = 1:size(test_cases,1)
        ...
        l2_err_indirect(i,indx) = norm(indirect_err,2)/norm(pdx_sph32_mathematica, 2);
...
figure(2)
%hold on;
loglog(prob_sizes, abs(abs_l2_diff),'o-','LineWidth',2);
%title({'Difference', 'Rel l2 Errors'}, 'FontSize', 28);
xlabel('N','FontSize', 28);
...
if 1
    ...
    figure(8)
    plotScalarfield(pdx_sph32_mathematica, nodes, 'P_x ^d/_{dx} [ Sph[3,2] ]')
end
return
