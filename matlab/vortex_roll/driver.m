...
fdsize = 31; c1 = 0.035; c2 = 0.1 ; hv_k = 4; hv_gamma = 250;
hv_k = 6; hv_gamma = 100000;
%fdsize = 50; c1 = 0.044; c2 = 0.14;  hv_k = 6; hv_gamma = 5;
%fdsize = 101;c1 = 0.058; c2 = 0.16;  hv_k = 8; hv_gamma=5e-2; %hv_k = 6; hv_gamma = 5;
...
[DM_Lambda DM_Theta H] = Calc_Weights_fd(fdsize, N, nodes, ep, hv_k);
% 
%  gamma=[3000];
